...
export function TransactionTimeline(props: Props) {
  ...
  return (
    <section className="mt-8">
      ...
      {err && (
        <div className="mb-3 rounded border border-red-200 bg-red-50 dark:border-red-900/40 dark:bg-red-950/40 px-3 py-2 text-xs text-red-700 dark:border-red-900/40 dark:bg-red-950/40 dark:text-red-200">
          {err}
        </div>
      )}
